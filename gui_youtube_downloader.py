...
class YouTubeDownloaderApp:
    ...
    def download(self):
        ...
        if not download_path:
            messagebox.showerror("Error", "Selecciona una carpeta de descargas.")
            return
        ...
        if format == "mp3":
            ...
            try:
                ...
                print(f"Archivo MP3 convertido: {ruta_mp3}")
            ...
            try:
                ...
                messagebox.showinfo("Éxito", f"Descarga completada: {ruta_mp4}")
                print(f"Archivo MP4 movido: {ruta_mp4}")
            except Exception as e:
                messagebox.showerror("Error", f"Error al mover el archivo: {e}")
    ...
    def on_progress(self, stream, chunk, bytes_remaining):
        ...
        print(f"Progreso: {percentage:.1f}% - {bytes_downloaded // 1024} KB de {total_size // 1024} KB")
        self.root.update_idletasks()

    def toggle_dark_mode(self):
        current_theme = self.style.theme_use()
        print(f"Tema actual: {current_theme}")
